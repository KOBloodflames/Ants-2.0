...
typedef struct {cell_type type; int owner; int bfs; int bfsvisited; int move; int vision; int danger; int ant;} cell;
...
typedef struct {char *routelist; int x; int y; int distance;} route;

/*linked list*/
struct Node;
typedef struct Item{int id; int x; int y; ant_role role; direction lastmove; int alive; int routenr; route *routes; int fight; int moving; int targetx; int targety;} Item;
...
typedef struct {cell **map; int rows; int cols; unsigned int turn; int end; ant *ants; int antnr; int razing; int razex; int razey; int defend; int territories;} worldmap;
